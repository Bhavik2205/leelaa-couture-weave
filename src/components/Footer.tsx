            ...
            <div className="space-y-4">
              ...
              <div className="flex">
                <input 
                  ...
                  className="flex-1 px-4 py-2 bg-ivory/10 border border-ivory/20 rounded-l-lg focus:outline-none focus:border-gold text-ivory placeholder-ivory/60"
                />
                <button className="px-6 py-2 bg-gold text-maroon font-montserrat font-medium rounded-r-lg hover:bg-gold/90 transition-colors duration-300">
                  Subscribe
                </button>
              </div>
            </div>
